...
WHERE id IN (
    ...
    WHERE kind IN ('story_chapter_generation', 'story_chapter_batch_plan') AND thread_id IS NOT NULL
);
DELETE FROM workflows WHERE kind IN ('story_chapter_generation', 'story_chapter_batch_plan');
