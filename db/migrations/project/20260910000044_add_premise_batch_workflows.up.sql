...
CREATE TABLE workflows_premise_batch_new (
    ...
    CONSTRAINT workflows_kind_check CHECK (kind IN ('yolo_project_initialization', 'premise_asset_generation', 'comic_section_image_generation', 'comic_image_generation_batch', 'comic_storyboard_generation', 'story_chapter_generation', 'story_chapter_batch_plan', 'story_profile_generation', 'story_profile_from_chapters', 'premise_batch_generation')),
