...
func TestFailedMigrationRestoresConsistentBackup(t *testing.T) {
	...
	brokenFS := fstest.MapFS{
		"20260826000028_break.up.sql":   {Data: []byte("CREATE TABLE half_written (id INTEGER); THIS IS NOT SQL;")},
		"20260826000028_break.down.sql": {Data: []byte("DROP TABLE half_written;")},
	}
