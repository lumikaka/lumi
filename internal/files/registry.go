...
var purposeRegistry = map[string]purposePolicy{
	...
	"project_chat_image_generation":       {Namespace: "chat/generated", AllowedMIME: mimeSet("image/png", "image/jpeg", "image/webp"), MaxBytes: 64 << 20, MaxPixels: 80_000_000, MetadataKeys: mimeSet("source", "tool_execution_uuid", "chat_thread_uuid", "chat_run_uuid", "reference_uuids", "reference_types", "resolved_file_uuids", "revised_prompt")},
