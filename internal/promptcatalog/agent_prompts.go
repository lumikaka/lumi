...
func previousAgentBaseDefaults(value, language string) []string {
	...
	legacyBootstrap := strings.Replace(value, currentBootstrap, previousBootstrap, 1)
	...
	return []string{legacyBootstrap, withoutBootstrap, previousUIRef, previousInputRule, strings.Replace(previousInputRule, currentGuide, previousGuide, 1)}
}
